...
fight_time_minutes <- function(rounds,time_in_round){
  # Computes the length of a fight in minutes
  ifelse(rounds == 1,
...
format_decision_name2 <- function(name){
  if(name == "U-DEC"){
...
outcomes_within_method_type <- function(type,data_frame){
  # Shows the percentages of fights ending in a certain type of finish given a method, e.g. a specific submission
  # or type of knockout.
  if(type == "KO"){
